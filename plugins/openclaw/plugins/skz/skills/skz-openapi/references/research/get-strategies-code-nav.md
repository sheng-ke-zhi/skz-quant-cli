---
title: 实盘策略净值
endpoint: GET /research/strategies/{code}/nav
...
完整地址：`GET https://api.shengkezhi.com/open/v1/research/strategies/{code}/nav`
...
```json
{
  ...
  "data": {
    ...
    "dates": ["2025-01-17 00:00:00", "2025-01-20 00:00:00", "2025-01-21 00:00:00"],
    "nav": [1.0, 1.0, 0.9999394528991177],
    "drawdown": [0.0, 0.0, -6.0547100882352156e-05]
  }
}
```
