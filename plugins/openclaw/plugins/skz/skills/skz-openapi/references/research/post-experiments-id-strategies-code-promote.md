---
title: 创建实盘价值审核任务
endpoint: POST /research/experiments/{id}/strategies/{code}/promote
...
实际调用地址：`https://api.shengkezhi.com/open/v1/research/experiments/{id}/strategies/{code}/promote`。需在请求头携带 `Authorization: Bearer sk_xxx`。
