---
title: 实盘价值审核任务详情
endpoint: GET /research/promotions/{promotion_id}
source: https://docs.shengkezhi.com/api/research/get-promotions-promotion-id
---
...
完整地址：`GET https://api.shengkezhi.com/open/v1/research/promotions/{promotion_id}`
...
| 参数 | 位置 | 类型 | 必填 | 默认值 | 说明 |
| --- | --- | --- | --- | --- | --- |
| promotion_id | path | string | 是 | - | promote 接口返回的实盘更新任务编号 |
