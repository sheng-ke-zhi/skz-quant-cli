---
title: 导入策略
endpoint: POST /research/strategy-imports
...
实际调用地址：`https://api.shengkezhi.com/open/v1/research/strategy-imports`。需在请求头携带 `Authorization: Bearer sk_xxx`。
