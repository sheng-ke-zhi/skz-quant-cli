---
title: 更新实盘策略状态
endpoint: PATCH /research/strategies/{code}/status
...
实际调用地址：`https://api.shengkezhi.com/open/v1/research/strategies/{code}/status`。需在请求头携带 `Authorization: Bearer sk_xxx`。
