---
title: 删除策略研究产出
endpoint: DELETE /research/experiments/{id}/strategies/{code}
...
实际调用地址：`https://api.shengkezhi.com/open/v1/research/experiments/{id}/strategies/{code}`。需在请求头携带 `Authorization: Bearer sk_xxx`。
