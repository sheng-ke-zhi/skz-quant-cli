---
title: 因子详情
endpoint: GET /research/factors/{factor_name}
...
完整地址：`GET https://api.shengkezhi.com/open/v1/research/factors/{factor_name}`
...
```json
{
  ...
  "data": {
    ...
    "evaluations": [
      { "problem": "FTS_PROBLEM_D_60144637", "method": "MA001", "status": "success", "sharpe": 0.878, "calmar": 0.5328 },
      { "problem": "FTS_PROBLEM_D_60144637", "method": "TS001", "status": "success", "sharpe": 1.2202, "calmar": 1.1559 },
      { "problem": "FTS_PROBLEM_D_60144637", "method": "TS002", "status": "success", "sharpe": 0.6851, "calmar": 0.6618 }
    ]
  }
}
```
