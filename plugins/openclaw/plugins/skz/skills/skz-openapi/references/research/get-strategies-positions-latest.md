---
title: 批量查询最新仓位
endpoint: GET /research/strategies/positions/latest
...
完整地址：`GET https://api.shengkezhi.com/open/v1/research/strategies/positions/latest`
...
```bash
curl -X GET "https://api.shengkezhi.com/open/v1/research/strategies/positions/latest?weight_type=ts" \
