---
title: 实盘策略周期收益
endpoint: GET /research/strategies/{code}/periodic
...
完整地址：`GET https://api.shengkezhi.com/open/v1/research/strategies/{code}/periodic`
...
```json
{
  ...
  "data": {
    "monthly": {
      ...
      "months": [1, 2],
      "matrix": [
        [-0.000976838153664531, -0.006986891372798237],
        [0.006793218252199779, 0.034930561121631384]
      ]
    },
    "yearly": {
